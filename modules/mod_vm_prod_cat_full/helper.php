...
class modVMFullCategoryList {
    ...
    function getCatParent($categoryId = 0) {

        $db = JFactory::getDBO();
        $q = "select cc.category_parent_id,c.category_name
	from u4ria_virtuemart_category_categories as cc
	join u4ria_virtuemart_categories_en_gb as c on cc.category_child_id = c.virtuemart_category_id

...
foreach ($categories as $category) {
		...
		$caturl = JRoute::_('index.php?option=com_virtuemart&view=popupcategory&task=popupcategory&virtuemart_category_id='.$category->virtuemart_category_id . '&tmpl=component');
		...
		?>
		<div class="<?php if ($i%3==0){?>homecat-outbound-last<?php } else { ?>homecat-outbound<?php }?>">		
			<div class="homecat">
	...
	<div id="boxpopup" class="box">
		...
		<div id="content">
			<iframe id="pagepopup"	src="" scrolling="auto"	frameborder="0" width="1000" height="480"></iframe>
		</div>
	</div>	

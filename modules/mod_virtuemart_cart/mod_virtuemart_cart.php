...
//$reward_point_added = isset($_SESSION['rp_added']) ? $_SESSION['rp_added'] : 0;
...
$data->cart_show = '<a style ="float:right;" href="'.JRoute::_("index.php?option=com_virtuemart&view=cart&step=1".$taskRoute,$useXHTML,$useSSL).'">'.$linkName.'</a>';
$data->billTotal = $lang->_('COM_VIRTUEMART_CART_TOTAL').' : <strong>'. $currencyDisplay->priceDisplay($cart->pricesUnformatted['billTotal']) .'</strong>';

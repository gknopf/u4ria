...
require_once ( dirname(__FILE__) . DS . 'libs' . DS . 'CSS.php' );
require_once ( dirname(__FILE__) . DS . 'libs' . DS . 'HTML.php' );
require_once ( dirname(__FILE__) . DS . 'libs' . DS . 'jsmin.php' );
...
class plgSystemJCH_Optimize extends JPlugin {
    ...
    protected function buildUrl($sFile, $sType, $iTime, $bGz=false) {
        $sPath = JURI::base(true) . '/plugins/system/jch_optimize/libs/';
    ...
    protected function generateSprite($sCss, $sLnEnd) {
        ...
        require_once ( dirname(__FILE__) . DS . 'libs' . DS . 'css-sprite-gen.inc.php' );

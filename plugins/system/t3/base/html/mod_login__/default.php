...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
	...
	<div id="form-login-username" class="control-group">
		...
		<?php if (!$params->get('usetext')) : ?>
			<div class="input-prepend">
				<span class="add-on"><i class="icon-user tip" title="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>"><?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?></i></span>
	...
	<div id="form-login-password" class="control-group">
		...
		<?php if (!$params->get('usetext')) : ?>
			<div class="input-prepend">
				<span class="add-on"><i class="icon-lock tip" title="<?php echo JText::_('JGLOBAL_PASSWORD') ?>"><?php echo JText::_('JGLOBAL_PASSWORD') ?></i></span>

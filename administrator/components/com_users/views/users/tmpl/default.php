	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class="nowrap" width="5%">
					<?php echo JText::_('COM_USERS_HEADING_LEVEL_TYPE'); ?>
				</th>
				<th class="nowrap" width="10%">
		...
		?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center">
					<?php if ($item->level_type  < 0): echo '-------'; elseif ($item->level_type == 1): echo 'Standard'; elseif ($item->level_type == 2): echo 'Silver'; elseif ($item->level_type == 3): echo 'Gold'; elseif ($item->level_type == 4): echo 'Platinum';  endif; ?>
				</td>

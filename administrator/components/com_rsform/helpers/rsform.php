...
DEFINE('_RSFORM_COPYRIGHT','&copy;2007-2012 REdBitZ.COM | More Joomla Download');
DEFINE('_RSFORM_LICENSE','GPL Commercial License');
DEFINE('_RSFORM_AUTHOR','<a href="http://redbitz.com" target="_blank">REdBitZ.COM</a>');
DEFINE('_RSFORM_WEBSITE','http://redbitz.com/');

 ...
 * @package		VirtueMart
 */
class TableLabel_medias extends VmTableXarray {
	...
	function __construct(&$db){
		parent::__construct('#__virtuemart_label_medias', 'id', $db);

		$this->setPrimaryKey('virtuemart_label_id');

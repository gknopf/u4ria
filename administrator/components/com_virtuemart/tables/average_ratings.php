 ...
 * @author Max Milbers
 */
class TableAverage_Ratings extends VmTable {

	/** @var int Product ID */

	var $virtuemart_average_rating_id	= 0;
	...
	*/
	function __construct(&$db) {
		parent::__construct('#__virtuemart_average_ratings', 'virtuemart_average_rating_id', $db);
		//In a VmTable the primary key is the same as the _tbl_key and therefore not needed
  		$this->setPrimaryKey('virtuemart_average_rating_id');
//		$this->setObligatoryKeys('virtuemart_product_id');

		$this->setLoggable();

		$this->setTableShortCut('ar');
	}
}

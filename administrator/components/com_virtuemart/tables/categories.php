...
// 		$this->setPrimaryKey('virtuemart_category_id');
                ...
                $this->setLoggable();
                $this->setTranslatable(array('category_name', 'catagory_short_des', 'category_description', 'metadesc', 'metakey', 'customtitle'));

 ...
 * @author Max Milbers
 */
class TableMarket_prices extends VmTable {

	/** @var int Primary key */
	var $virtuemart_market_price_id = 0;
	...
	{
		parent::__construct('#__virtuemart_market_prices', 'virtuemart_market_price_id', $db);
		$this->setTableShortCut('mk');
	}

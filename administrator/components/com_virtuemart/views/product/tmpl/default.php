	...
	<table class="">
		<tr>
			...
			<?php echo JText::_('COM_VIRTUEMART_FILTER') ?>:
				<select class="inputbox" id="virtuemart_category_id" 
                                        style="width: 200px;"
                                        name="virtuemart_category_id" onchange="document.adminForm.submit(); return false;">
                ...
                <tr>
                    <td>
                        <span class="cfi"> Include Sub Categories</span>
                        <input type="checkbox" name="sinsub" value="checked" <?php echo $this->sinsub; ?>/>
                    </td>
                </tr>
	</table>
	</div>

...
<fieldset>
	...
	<?php echo $this->editor->display('product_desc',  $this->product->product_desc, '100%;', '350', '75', '20', array('pagebreak', 'readmore') ) ; ?>
</fieldset>


<fieldset>
	<legend><?php echo JText::_('COM_VIRTUEMART_PRODUCT_FEATURES') ?></legend>
	<?php echo $this->editor->display('product_feature',  $this->product->product_feature, '100%;', '350', '75', '20', array('pagebreak', 'readmore') ) ; ?>
</fieldset>

<fieldset>
	<legend><?php echo JText::_('COM_VIRTUEMART_PRODUCT_DETAILS') ?></legend>
	<?php echo $this->editor->display('product_detail',  $this->product->product_detail, '100%;', '350', '75', '20', array('pagebreak', 'readmore') ) ; ?>
</fieldset>
<fieldset>

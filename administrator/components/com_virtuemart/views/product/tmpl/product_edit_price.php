...
<table class="adminform" class="productPriceTable">
    ...
    <tr class="row<?php echo $rowColor?>" style="display: none">
        <td>
            <div style="text-align: right; font-weight: bold;">
								<span
                                        class="hasTip"
    ...
    <tr class="row<?php echo $rowColor?>">
        <td width="120px">
            <div style="text-align: right; font-weight: bold;">
                <span class="hasTip" title="<?php echo JText::_ ('COM_VIRTUEMART_RETAIL_PRICE_TIP'); ?>"><?php echo JText::_ ('COM_VIRTUEMART_RETAIL_PRICE') ?></span>
            </div>
        </td>
        <td width="140px">
          <input type="text" class="inputbox" name="mprices[retail_price][]" size="12" style="text-align:right;" value="<?php echo $this->calculatedPrices['retailPrice']; ?>"/>
        </td>
        <td colspan="3">
        </td>
        <td colspan="2">
    ...
    <tr class="row<?php echo $rowColor?>">
        <td width="120px">
            <div style="text-align: right; font-weight: bold;">
                <span class="hasTip" title="<?php echo JText::_ ('COM_VIRTUEMART_IMPORT_PRICE_TIP'); ?>"><?php echo JText::_ ('COM_VIRTUEMART_IMPORT_PRICE') ?></span>
            </div>
        </td>
        <td width="140px">
          <input type="text" class="inputbox" name="mprices[import_price][]" size="12" style="text-align:right;" value="<?php echo $this->calculatedPrices['importPrice']; ?>"/>
        </td>
        <td colspan="3">
        </td>
        <td colspan="2">

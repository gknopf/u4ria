...
class VirtuemartViewManufacturer extends VmView {
        ...
        function display($tpl = null) {
                ...
                if ($layoutName == 'edit') {
                        ...
                        //   echo       $virtuemart_manufacturercategories_id = $mainframe->getUserStateFromRequest($option . 'virtuemart_manufacturercategories_id', 'virtuemart_manufacturercategories_id', 0, 'int');
                        echo $session->get($option . 'virtuemart_manufacturercategories_id');
                        if ($task == 'listall')
                                $mainframe->setUserState("$option.virtuemart_manufacturercategories_id", 0);

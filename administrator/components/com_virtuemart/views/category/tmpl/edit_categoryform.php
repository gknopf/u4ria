	...
	<tr>
		...
		<fieldset>
			...
			<table width="100%" border="0">
				...
				<?php echo VmHTML::row('input','COM_VIRTUEMART_CATEGORY_SHORT_DES','catagory_short_des',$this->category->catagory_short_des); ?>
				...
				<?php echo VmHTML::row('booleanlist','COM_VIRTUEMART_SHOW_HOME_MENU','show_in_menu',$this->category->show_in_menu); ?> 
				<?php echo VmHTML::row('editor','COM_VIRTUEMART_DESCRIPTION','category_description',$this->category->category_description); ?>
                                                          
				<?php echo VmHTML::row('booleanlist','COM_VIRTUEMART_TOP10','top10',$this->category->top10); ?>
				<?php echo VmHTML::row('booleanlist','COM_VIRTUEMART_TOP10BS','top10bs',$this->category->top10bs); ?>  
                                <?php echo VmHTML::row('booleanlist','COM_VIRTUEMART_TOP_40_FOR_GENDER','top40',$this->category->top40); ?>                                             
				<?php echo VmHTML::row('booleanlist','COM_VIRTUEMART_TOP_FOR_MANUFACTURE','top_for_manufacturer',$this->category->top_for_manufacturer); ?>
				<?php echo VmHTML::row('booleanlist','COM_VIRTUEMART_TOP_FOR_BRAND','top_for_brand',$this->category->top_for_brand); ?>      
                                                                <?php $mlist = '
						<select name="manufacturer_id" id="manufacturer_id" class="inputbox">
							<option value="">'.JText::_('COM_VIRTUEMART_TOP_FOR_MANUFACTURE_TOP_LEVEL').'</option>'
							.$this->manulist.
						'</select>';
						echo VmHTML::row('raw','COM_VIRTUEMART_CATEGORY_MANUFACTURE_NAME', $mlist ); ?>
                                                                <?php $blist = '
						<select name="brand_id" id="brand_id" class="inputbox">
							<option value="">'.JText::_('COM_VIRTUEMART_TOP_FOR_BRAND_TOP_LEVEL').'</option>
							'.$this->brandlist.'
						</select>';
						echo VmHTML::row('raw','COM_VIRTUEMART_CATEGORY_BRAND_NAME', $blist ); ?>                                                                

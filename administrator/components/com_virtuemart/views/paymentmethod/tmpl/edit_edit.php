...
<div class="col50">
    ...
    <fieldset>
	<legend><?php echo JText::_('COM_VIRTUEMART_PAYMENT_FORM_DESCRIPTION') ?></legend>
	<?php echo $this->editor->display('payment_desc',  $this->payment->payment_desc, '100%;', '350', '75', '20', array('pagebreak', 'readmore') ) ; ?>
</fieldset>
</div>

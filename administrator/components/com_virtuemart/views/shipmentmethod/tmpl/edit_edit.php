...
<div class="col50">
    ...
    <fieldset>
	<legend><?php echo JText::_('COM_VIRTUEMART_SHIPPING_FORM_DESCRIPTION') ?></legend>
	<?php echo $this->editor->display('shipment_desc',  $this->shipment->shipment_desc, '100%;', '350', '75', '20', array('pagebreak', 'readmore') ) ; ?>
</fieldset>
</div>

		...
		<table class="adminlist">
			<tr>
				<td>
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSF_FIREWALL_LISTS'); ?> :: <?php echo JText::_('RSF_FIREWALL_LISTS_DESC'); ?>">
							<a href="index.php?option=com_rsfirewall&amp;view=lists">
								<?php echo JHTML::_('image', 'administrator/components/com_rsfirewall/assets/images/lists.png', JText::_('RSF_FIREWALL_LISTS')); ?>
								<span><?php echo JText::_('RSF_FIREWALL_LISTS'); ?></span>
							</a>
						</div>
					</div>
					<div style="float: left">

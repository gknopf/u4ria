 ...
 * @since		1.6
 */
class UsersControllerRegrequire extends UsersController
{
	/**
	...
	public function activate()
	{
		...
		elseif ($return->getParam('activate'))
		{
			...
			$this->setRedirect(JRoute::_('index.php?option=com_users&view=regrequire&layout=complete', false));
		}
		else
		{
	...
	public function register()
	{
		...
		if(!$res[0]){
			...
			$this->setRedirect(JRoute::_('index.php?option=com_users&view=regrequire&reg=1'), $msg);
			return;
		}
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_users&view=regrequire&reg=1', false));
			return false;
		}
...
//			$this->setMessage(JText::_('COM_USERS_REGISTRATION_COMPLETE_ACTIVATE'));
    ...
    function saveCheckoutUser() {
		...
		if(!$res[0]){
			$msg = "Kindly key in your security check. Thank you!";
			$this->setRedirect(JRoute::_('index.php?option=com_users&view=regrequire'), $msg);
			return;
		}
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_virtuemart&view=user&task=editaddresscheckout&tab=viewaddress'));
    }
}

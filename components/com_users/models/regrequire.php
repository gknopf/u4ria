 ...
 * @since		1.6
 */
class UsersModelRegrequire extends JModelForm
{
	/**
	...
	public function activate($token)
	{
		...
		if (($userParams->get('useractivation') == 2) && !$user->getParam('activate', 0))
		{
			...
			$data['activate'] = $base.JRoute::_('index.php?option=com_users&task=regrequire.activate&token='.$data['activation'], false);
			...
			$emailBody = JText::sprintf(
				...
				$data['email'],
				$data['username'],
				$data['siteurl'].'index.php?option=com_users&task=regrequire.activate&token='.$data['activation']
			);

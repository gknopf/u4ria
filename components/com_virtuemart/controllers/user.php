...
//        $this->setRedirect(JRoute::_('index.php?option=com_virtuemart&amp;view=cart&amp;task=edit_shipment'));
    ...
    private function saveData($cart = false, $register = false, $onlyAddress = false) {
        ...
        if ($data['address_type'] == 'XT' && $data['BTsameAsST'] == 1) {
            $prefix = 'shipto_';
            if (!class_exists('VirtueMartModelUserfields'))
            require(JPATH_VM_ADMINISTRATOR . DS . 'models' . DS . 'userfields.php' );
            $userFieldsModel = VmModel::getModel('userfields');
            $prepareUserFields = $userFieldsModel->getUserFieldsFor('cart', 'BT');

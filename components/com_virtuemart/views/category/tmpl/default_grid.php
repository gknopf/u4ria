				...
				<div class="width100 floatleft center product_image">
				    ...
				    <?php endif; ?>
						...
						?>
                                ...
                                <div class="width100 floatright dgf">
                                    <div class="width100 floatright product_name">
                                    <?php if (strlen($product->product_name) < 25):
                                        $new_name = $product->product_name;
                                    else:
                                        $new_name = substr($product->product_name, 0, strrpos(substr($product->product_name, 0, 25), ' ')) . ' ...'; endif; ?>
                                    ...
                                    <!-- The "Average Customer Rating" Part -->
                                            <?php if ($this->showRating) {
                                                if (empty($product->rating)) {
                                                    ?>
                                                    <span class="vote"><?php echo '<span class="ratinglable">'.JText::_('COM_VIRTUEMART_AVERAGE_RATING') . '</span> ' . JText::_('COM_VIRTUEMART_UNRATED') ?></span>
                                                        <?php
                                                    } else {
                                                        ...
                                                        ?>
                                                    <span class="vote">
                                                        <span class="ratinglable"><?php echo JText::_('COM_VIRTUEMART_RATING_AVE'); ?></span>
                                            ...
                                            <?php if ($this->showRating) {
                                                if (empty($product->votes)) {
                                                    ?>
                                                    <span class="vote"><?php echo '<span class="ratinglable">'.JText::_('COM_VIRTUEMART_PRODUCT_LIST_RATING') . '</span> ' . JText::_('COM_VIRTUEMART_UNRATED') ?></span>
                                                        <?php
                                                    } else {
                                                        $ratingwidth = $product->votes->rating * 12; //I don't use round as percetntage with works perfect, as for me
                                                        ?>
                                                    <span class="vote">
                                                        <span class="ratinglable"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_LIST_RATING'); ?></span>
                                ...
                                <div class="width100 floatleft cbicon">
                                    <div class="floatleft">
                                        ...
                                        <div class="icpp"><a  href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=pricematch&pid='.$product->virtuemart_product_id); ?>" class="price_match" title="<?php echo JText::_('PRICE_MATCH') ?>"><img title="<?php echo JText::_('PRICE_MATCH') ?>" alt="<?php echo JText::_('COM_VIRTUEMART_PRICE_MATCH') ?>" title="<?php echo JText::_('COM_VIRTUEMART_PRICE_MATCH') ?>" src="<?php echo $this->baseurl ?>/templates/altalab/images/pricematch.jpg" /></a></div>
                                    </div>

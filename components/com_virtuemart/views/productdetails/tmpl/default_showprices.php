...
//   	}
  	...
  	echo $this->currency->createPriceDiv('retailPrice', 'COM_VIRTUEMART_PRODUCT_RETAIL_PRICE', $this->product->prices);
  	echo $this->currency->createPriceDiv('salesPrice', 'COM_VIRTUEMART_PRODUCT_SALESPRICE', $this->product->prices);
  	echo $this->currency->createPriceDiv('memberPrice', 'COM_VIRTUEMART_PRODUCT_MEMBER_PRICE', $this->product->prices);

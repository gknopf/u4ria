 ...
 * @version $Id: view.html.php 4620 2011-11-08 20:09:09Z Milbo $
 */
 ...
 */
class VirtuemartViewPopupCategory extends JView {
    ...
    public function display($tpl = null) {
        ...
        // Set Canonic link
        $document->addHeadLink(JRoute::_('index.php?option=com_virtuemart&view=popupcategory&virtuemart_category_id=' . $categoryId), 'canonical', 'rel', '');
        ...
        foreach ($products as $product) {
            ...
            //$product->votes = $productModel->getVotes($product->virtuemart_product_id) ;

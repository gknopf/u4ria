...
<style type="text/css">
    ...
    .sizeinputselectbirthday{ width: 100px; height: 22px;}
</style>
            ...
            <tr>
                ...
                <td>
                    <?php if ($field['type'] == 'radio' && $field['name'] == 'shipto_gender') {
                        ...
                        <select name ="shipto_date_of_birth[year]" class="required" class="sizeinputselectbirthday"
                                        id="yearField1"
                        ...
                        <select onchange="resetMonthAndDayByMonth(1);" size="1" class="required" class="sizeinputselectbirthday" name="shipto_date_of_birth[month]" id="jform_month1">
                    ...
                    <td>
                        <?php if ($field['type'] == 'radio' && $field['name'] == 'gender') {
                            ...
                            <input type="radio" name="gender" value="2" id="gender_2"
                                   ...
                                   ?>
                            <select name ="date_of_birth[year]" class="required" class="sizeinputselectbirthday"
                                            id="yearField2"
                            ...
                            <select onchange="resetMonthAndDayByMonth(2);" size="1" class="required" class="sizeinputselectbirthday" name="date_of_birth[month]" id="jform_month2">
                                        <option selected="selected" value="0">Month</option>    
                                        <?php
                                        $month = "";
                                        $monthNo = 0;

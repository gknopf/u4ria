...
?>
<table class="html-email" width="100%" cellspacing="0" cellpadding="0" border="0" style="border: 1px solid silver">
	<tr align="left" class="sectiontableheader" style="background-color: silver">
		<td align="left" width="5%" style="padding: 10px;"><strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SKU') ?></strong></td>
		<td align="left" colspan="2" width="38%" style="padding: 10px;"><strong><?php echo JText::_('COM_VIRTUEMART_PRODUCT_NAME_TITLE') ?></strong></td>
		<td align="center" width="10%" style="padding: 10px;"><strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_STATUS') ?></strong></td>
		<td align="center" width="10%" style="padding: 10px;"><strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_PRICE') ?></strong></td>
		<td align="center" width="6%" style="padding: 10px;"><strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_QTY') ?></strong></td>
		<?php if ( VmConfig::get('show_tax')) { ?>
		<td align="center" width="10%" style="padding: 10px;"><strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_TAX') ?></strong></td>
		  <?php } ?>
		<td align="center" width="11%" style="padding: 10px;;"><strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SUBTOTAL_DISCOUNT_AMOUNT') ?></strong></td>
		<td align="right" width="11%" style="padding: 10px;"><strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?></strong></td>
	</tr>
...
<?php
	...
	foreach($this->orderDetails['items'] as $item) {
		...
		?>
		<tr valign="top" <?php if($i%2!=0){?> style="background-color: #f2f2f2" <?php }?> >
			<td align="left" style="padding: 10px;border-bottom: 1px dotted silver;">
				<?php echo $item->order_item_sku; ?>
			</td>
			<td align="left" colspan="2" style="padding: 10px;border-bottom: 1px dotted silver;">
...
// 				vmdebug('$item',$item);
			...
			<td align="center" style="padding: 10px;border-bottom: 1px dotted silver;">
				<?php echo $this->orderstatuses[$item->order_status]; ?>
			</td>
			<td align="center"   class="priceCol" style="padding: 10px;border-bottom: 1px dotted silver;">
			...
			<?php if ( VmConfig::get('show_tax')) { ?>
				<td align="right" class="priceCol" style="padding: 10px;border-bottom: 1px dotted silver;"><?php echo "<span  class='priceColor2'>".$this->currency->priceDisplay($item->product_tax ,$this->currency, $qtt)."</span>" ?></td>
                                <?php } ?>
			<td align="right" class="priceCol" style="padding: 10px;border-bottom: 1px dotted silver;">
...
<?php  } ?>
	...
	<tr>
		<td align="right" class="pricePad" colspan="6"> Shipping Fee<?php // echo $this->orderDetails['shipmentName'] ?></td>
	...
	<tr>
		<td align="right" class="pricePad" colspan="6"> Payment Fee<!--method:--> <?php //echo $this->orderDetails['paymentName'] ?></td>

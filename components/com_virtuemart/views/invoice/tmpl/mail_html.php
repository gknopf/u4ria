...
<html>
    ...
    <span style="font-size: 9pt"> This email is sending by automatic delivery system to the shoppers for <a href="<?php echo JURI::root(); ?>">u4riashop.com</a></span>
	<br/>
    <span style="font-size: 50pt;font-family: Bell MT;">U4Ria</span>
    <hr/>
    <div style="" width="100%">

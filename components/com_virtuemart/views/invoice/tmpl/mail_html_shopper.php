...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
  ...
  <td rowspan="3" width="40%">
      <p style="font-size: 12pt;font-weight: 600;"><?php echo JText::sprintf('COM_VIRTUEMART_MAIL_ORDER_STATUS',JText::_($this->orderDetails['details']['BT']->order_status_name)) ; ?></p>
  </td>
  </tr>

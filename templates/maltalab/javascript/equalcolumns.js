...
//// corresponding column actually exists:
...
//		for ( var i = 0; i < this.columnswatch.length; i++) {
//			if (document.getElementById(this.columnswatch[i]) != null)
//				document.getElementById(this.columnswatch[i]).style.height = tallest
//						+ "px"
//		}
//	}
//}
...
//}
//
//ddequalcolumns.dotask = function(target, functionref, tasktype) { // assign a
//																																	// function to
//																																	// execute to
//																																	// an event
//																																	// handler
...
//}, "load")
//ddequalcolumns.dotask(window, function() {
//	if (typeof ddequalcolumns.timer != "undefined")
//		clearTimeout(ddequalcolumns.timer);

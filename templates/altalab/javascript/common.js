...
{
    var url = vmSiteurl + "index.php?option=com_virtuemart&view=cart&task=addproductjs";
...
function add_reward_point()
{
    ...
    jQuery.post(url, parameter, function(res) {
        ...
        if (res.error == 0) {
            ...
            jQuery('#convertpoints').html(res.convert_to_price);
        } else {
